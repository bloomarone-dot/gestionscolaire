"""eleves-service — Inscriptions (cascade + filtre classes), héritage matières, transferts, promotions.
...
app = create_service_app(title="eleves-service — SaaS Scolaire", on_startup=_startup)
