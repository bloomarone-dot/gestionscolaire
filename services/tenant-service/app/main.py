"""tenant-service — Profil école, sous-systèmes/types actifs, canaux de notif, abonnement.
...
app = create_service_app(title="tenant-service — SaaS Scolaire", on_startup=_startup)
