"""personnel-service — Enseignants, Direction (2 téléphones), matières enseignables.
...
app = create_service_app(title="personnel-service — SaaS Scolaire", on_startup=_startup)
