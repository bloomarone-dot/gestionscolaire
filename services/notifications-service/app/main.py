"""notifications-service — SMS/WhatsApp/Email + notif interne, historique, consumer RabbitMQ.
...
app = create_service_app(title="notifications-service — SaaS Scolaire", on_startup=_startup)
